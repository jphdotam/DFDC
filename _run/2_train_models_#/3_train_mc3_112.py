...
We actually use 1 of these models to then train the MC3_224 model, which is identical but which is trained on 224*224
resolution images. 224*224 training requires a small batch size and so I used transfer learning from these 112*112
...
if __name__ == "__main__":
    ...
    for epoch in range(EPOCHS):
        ...
        torch.save(model.state_dict(), f"./saved_models/mc3_18_112_1cy_lilaug_nonorm_e{epoch}_l{losses.avg:.4f}.model")
